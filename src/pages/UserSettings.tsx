                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Input 
                        id="phone" 
                        defaultValue={user?.email === 'justin@thealphaandomega.org' ? '+91 XXXXXXXXXX' : '+1 (555) 123-4567'} 
                        className="mt-1 bg-gray-700 border-gray-600 text-white" 
                      />
                    </div>
                    <div>
                      <Label htmlFor="country" className="text-gray-300">Country</Label>
                      <Select defaultValue={user?.email === 'justin@thealphaandomega.org' ? 'in' : 'us'}>
                    ...
                    <div>
                      ...
                      <Select defaultValue={user?.email === 'justin@thealphaandomega.org' ? 'ist' : 'est'}>
                        <SelectTrigger className="mt-1 bg-gray-700 border-gray-600 text-white">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="bg-gray-700 border-gray-600">
